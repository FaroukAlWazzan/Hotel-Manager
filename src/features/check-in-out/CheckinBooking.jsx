...
function CheckinBooking() {
  ...
  useEffect(() => {
    ...
    setBreakfastAdded(booking?.hasBreakfast ?? false);
  }, [booking]);
    ...
    <>
      ...
      <Box>
        <Checkbox
          ...
          onChange={() => {
            setBreakfastAdded((c) => !c);
            setConfirmPaid(false);
          }}
          disabled={isLoading || isLoadingSettings || hasBreakfast}
          id="breakfast"
        >
      ...
      <Box>
        <Checkbox
          ...
          id="confirm"
        >
          I confirm that Mr/Mrs {guests.fullName} has paid the booking amount{" "}
          {!breakfastAdded
